# --------------------------------------
# How to run this application: (Version without CO2 calculation)
# --------------------------------------
...
# 4. Result in file example_payloads/response_{timestamp}_wo_co2.json
# --------------------------------------
    ...
    try:
        ...
        for pp in powerplants:
            if pp['type'] == 'gasfired':
                ...
                pp['cost_per_mwh'] = fuels['gas(euro/MWh)'] / pp['efficiency']
